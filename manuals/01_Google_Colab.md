...
[Google Colab](https://colab.research.google.com/) is a free cloud service that supports free GPU and TPU. It is a notebook environment that requires no setup to use. It allows you to write and execute Python and R code in the browser and save your code in Google Drive. It also provides a way to share your code with others.
