# WORK IN PROGRESS
# Welcome to the TLS Practical Repository  

This repository is for the **Advanced Remote Sensing TLS Practical** at **UGent**.  
...
- Use **ITSMe** to calculate structural metrics from tree point clouds.  
